...

{
  ...
  'about' : 'A lightweight shin guard providing a soccer player the basic protection needed for all levels of play. The perforated foam padding gives it ergonomic comfort fit.',
  'state' : '',
  'toCompareState' : false
},
{
...
,
{
  ...
  'about' : 'Perfect for displaying proudly around the house, this 10" mini tennis racket impressively maintains the intricate details of its adult performance model.',
  'state' : '',
  'toCompareState' : false
},
    ...
    },
    {
      ...
      'about' : 'The Nike Everyday Plus Cushioned Socks bring comfort to your workout with extra cushioning under the heel and forefoot and a snug, supportive arch band. Sweat-wicking power and breathability up top help keep your feet dry and cool to help push you through that extra set.',
      'state' : '',
      'toCompareState' : false
    },
    {
      ...
      'about' : 'The Nike Dri-FIT Pop Swoosh Town (MLB Pittsburgh Pirates) T-Shirt has sweat-wicking technology to help provide a dry, comfortable game-day experience. Its team-inspired design is a perfect way to support your favorite team in MLB.',
      'state' : '',
      'toCompareState' : false
  },
  {
    ...
    'about' : 'Run, jump and pivot with confidence in the Nike Victory Shape Sports Bra. The snug, compressive design—with supportive molded cups—includes Dri-FIT technology to wick sweat away. Mesh on the back gives you breathability when youre going all out.',
    'state': '',
    'toCompareState' : false
},
{
  ...
  'about' : 'Head outside for casual warm-weather hikes. These sandals have comfortable textile straps and a buckle closure for a secure fit. The rubber outsole provides traction on wet or slippery surfaces.',
  'state' : '',
  'toCompareState' : false
},
{
  ...
  },
  {
    ...
    'about' : 'Throw some shade on your game. This adidas golf hat has a wide brim to keep the suns rays off your face and neck while moisture-absorbing AEROREADY keeps you dry. Adjust the drawcord when a breeze comes up, and swing for the pin.',
    'state' : '',
    'toCompareState' : false
},
{
...
},
{
  ...
  'about' : 'TPU molded cleat outsole provides superior traction on both turf and natural surfaces. Knit upper with Kinetic Stitch technology. Achilles pads for heel comfort. Lace closure for a secure fit. Hybrid tongue construction gives you the support of a mid-cut and look of a low-cut collar',
  'state' : '',
  'toCompareState' : false
},
{
...
},
{
  ...
  'about' : 'FuelCell foam delivers a propulsive feel to help drive you forward. Full-length external carbon fiber plate with six built-in pins for rigidity and traction. Knit synthetic/mesh upper with strategic internal reinforcement. Lace closure. Designed for middle to long distance track races',
  'state' : '',
  'toCompareState' : false
},
{
  ...
  'about' : 'Plush footbed held in a comfortable ground-contact EVA carrier. One-piece fixed upper. Plush top bed foam cushioning',
  'state' : '',
  'toCompareState' : false
},

{
  ...
  'about' : 'CFX CARBON FIBER: built with carbon fiber technology for gravity-defying support DEEP HEEL CUP cushions and protects against ground impac  MOISTURE-WICKING: engineered to control odor.',
  'state' : '',
  'toCompareState' : false
},
{
  ...
  'about' : 'Regular fit. Crew neck. All-over sublimation print on front and sleeves. PUMA and club name rubber print at chest. Official club logo rubber print at upper back',
  'state' : '',
  'toCompareState' : false
},
{
  ...
  'about' : 'Slim fit. Ribbed crew neck. 3D gradient transfer print. Features Dua Lipas signature butterfly',
  'state' : "",
  'toCompareState' : false
},
{
  ...
  'about' : 'Regular fit. Hood with drawcord for an adjustable fit. Kangaroo pocket. Ribbed cuffs and hem. PUMA Archive No. 1 Logo at chest',
  'state' : '',
  'toCompareState' : false
},
{
  ...
  'about' : 'Tight fit. High-waist construction. Side entry pockets. Mesh inserts at back of calves for ventilation. All-over Flawless texture',
  'state' : '',
  'toCompareState' : false
},
{
  ...
  'about' : 'Rectangular silhouette. Polycarbonate lenses. Injection molded frame. Formstrip design at temples. PUMA Cat Logo at temples and left corner lens',
  'state' : '',
  'toCompareState' : false
}
];
